...
let parent_events = {
  ...
  mouse: {parent: ["generic"], properties: ["x", "y", "layerX", "layerY", "movementX", "movementY", "offsetY", "offsetY", "pageX", "pageY", "screenX", "screenY", "altKey", "metaKey", "shiftKey", "mozInputSource", "webkitFroce"]},
...
//  dragover: {parent: "mouse", properties: [], functions: {}},
  ...
  // Mouse events
  wheel: {parent: ["mouse"], properties: ["deltaX", "deltaY", "deltaZ", "deltaMode", "wheelDelta"]}, // Check if not too many events
