...
// Entry point of the service worker
function main(config) {
    ...
    */
    ...
    let loggers_enabled = [
        ...
        websocket_logger(config?.server_url)
...
// Function to load the config object from the config.json file
async function loadConfig() {
  const configObject = await fetch(chrome.runtime.getURL('./config.json'))
    .then((response) => response.json())
    .then((data) => data);
  return configObject;
}

// load the config variables and initialize the service worker
