...
async def proxy(request):
    ...
    This should be a closure, so that it can be configured with the
    BASE_URL, ports, and other settings.
    '''
    print(request)
    ...
    if "referer" in headers:
        ...
        headers['referer'] = old_referer.replace("8080", "8889")
    ...
    async with aiohttp.ClientSession() as client:
        if request.method == "POST":
            ...
            raise NotImplementedError("Unsupported method: "+request.method)
